...
@onready var treasure_count: Label = $LevelMenu/LabelContainer/TreasureCount
@onready var total_treasures: Label = $LevelMenu/LabelContainer/TotalTreasures
...
func _ready() -> void:
	...
	total_treasures.text = " / %s" % treasures_in_level
...
func treasure_is_resgated() -> void:
	...
	treasure_count.text = str(treasures_resgated)
